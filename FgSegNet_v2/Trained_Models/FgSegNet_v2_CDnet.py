...
# -*- coding: utf-8 -*-
"""
training models for CDnet 2014 dataset
...
dataset = { 
            ...
            'lowFramerate':[ 'tunnelExit_0_35fps', 'turnpike_0_5fps'],
            'nightVideos':['busyBoulvard', 'fluidHighway', 'streetCornerAtNight', 'tramStation', 'winterStreet'],
